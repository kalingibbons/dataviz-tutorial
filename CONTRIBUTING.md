...
Welcome to `dataviz_tutorial` contributor's guide.
...
If you experience bugs or general issues with `dataviz_tutorial`, please have a look
...
You can help improve `dataviz_tutorial` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dataviz_tutorial` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dataviz_tutorial`'s files. While this mechanism can
...
```
conda create -n dataviz_tutorial python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dataviz_tutorial.git
   cd dataviz_tutorial
   ```
...
5. Install [pre-commit]:
   ...
   `dataviz_tutorial` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dataviz_tutorial
[issue tracker]: https://github.com/<USERNAME>/dataviz_tutorial/issues
